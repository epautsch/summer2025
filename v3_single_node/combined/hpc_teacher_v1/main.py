...
from prompts.builder_prompt import BUILDER_PROMPT
...
def main():
    ...
    builder_history = HistoryManager(summarizer=summarizer_llm)
    ...
    builder = BuilderAgent(model=builder_llm, history=builder_history)
